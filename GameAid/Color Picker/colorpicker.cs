...
namespace GameAid
{
    ...
    public class ColorPicker : Control
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            m_ColorDetail.MouseLeftButtonUp += new MouseButtonEventHandler(OnMouseLeftButtonUp);
        ...
        static void AChanged(DependencyObject d,
        ...
        static void RChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void GChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void BChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void ScAChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void ScRChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void ScGChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void ScBChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void HexadecimalStringChanged(DependencyObject d,
        DependencyPropertyChangedEventArgs e)
        {
            ColorPicker c = (ColorPicker)d;
        ...
        static void selectedColor_changed(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
        ...
        {
            if (e.LeftButton == MouseButtonState.Pressed && activeMoving)
            {
        ...
        TranslateTransform markerTransform = new TranslateTransform();
        Path m_ColorMarker;
